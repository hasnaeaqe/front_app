...
DROP TABLE IF EXISTS activite_admin CASCADE;
...
-- Table des utilisateurs (avec cabinet_id et specialite_id de database_updates.sql)
...
-- Table du cabinet (avec actif de database_updates.sql)
...
-- Table des médicaments (avec categorie et fabricant de database_updates.sql)
...
-- Table activite_admin (de database_updates.sql)
CREATE TABLE activite_admin (
    id SERIAL PRIMARY KEY,
...
-- Ajouter les contraintes de clé étrangère pour utilisateurs
ALTER TABLE utilisateurs ADD CONSTRAINT fk_utilisateurs_cabinet 
    FOREIGN KEY (cabinet_id) REFERENCES cabinet(id) ON DELETE SET NULL;
ALTER TABLE utilisateurs ADD CONSTRAINT fk_utilisateurs_specialite 
    FOREIGN KEY (specialite_id) REFERENCES specialite(id) ON DELETE SET NULL;

-- ===========================================
-- Section 3 : INSERTION DES DONNÉES DE TEST
-- ===========================================

-- 1. Insérer le cabinet
INSERT INTO cabinet (nom, adresse, num_tel, email, actif) VALUES
('Cabinet Médical Central', '123 Avenue Mohammed V, Casablanca', '0522123456', 'contact@cabinetcentral.ma', true);
...
-- 3. Insérer les médicaments (avec categorie et fabricant)
INSERT INTO medicament (nom, description, posologie, categorie, fabricant) VALUES
('Paracétamol', 'Antalgique et antipyrétique', '500mg toutes les 6 heures', 'Antalgique', 'Pfizer'),
('Ibuprofène', 'Anti-inflammatoire non stéroïdien', '400mg toutes les 8 heures', 'Anti-inflammatoire', 'Novartis'),
('Amoxicilline', 'Antibiotique', '500mg trois fois par jour', 'Antibiotique', 'Sanofi'),
('Oméprazole', 'Anti-acide', '20mg une fois par jour', 'Anti-acide', 'AstraZeneca'),
('Loratadine', 'Antihistaminique', '10mg une fois par jour', 'Antihistaminique', 'Bayer'),
('Salbutamol', 'Bronchodilatateur', '100mcg par inhalation', 'Bronchodilatateur', 'GlaxoSmithKline');

-- 4. Insérer les utilisateurs (avec cabinet_id et specialite_id)
-- Note : Les mots de passe sont hachés avec SHA-256 (hash de "password123")
INSERT INTO utilisateurs (nom, prenom, email, mot_de_passe, role, num_tel, cabinet_id, specialite_id) VALUES
-- Administrateur
('Admin', 'System', 'admin@cabinet.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 'ADMINISTRATEUR', '0522000001', 1, NULL),
-- Médecins (avec specialite_id)
('Benjelloun', 'Karim', 'medecin1@cabinet.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 'MEDECIN', '0522000002', 1, 1),
('El Fassi', 'Hassan', 'medecin2@cabinet.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 'MEDECIN', '0522000003', 1, 2),
('Berrada', 'Fatima', 'medecin3@cabinet.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 'MEDECIN', '0522000004', 1, 3),
('Alami', 'Mehdi', 'medecin4@cabinet.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 'MEDECIN', '0522000005', 1, 4),
-- Secrétaire
('Idrissi', 'Leila', 'secretaire@cabinet.com', 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', 'SECRETAIRE', '0522000006', 1, NULL);
...
-- 6. Insérer les dossiers médicaux
...
-- Index originaux de database_complete.sql
...
-- Index supplémentaires de database_updates.sql
...
CREATE INDEX idx_cabinet_actif ON cabinet(actif);
CREATE INDEX idx_activite_admin_date ON activite_admin(date_creation DESC);
...
-- ===========================================
-- Section 7 : VÉRIFICATION DES DONNÉES
-- ===========================================
